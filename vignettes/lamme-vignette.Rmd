...
Given the theoretical motivation and the empirical diagnostic, it is justified for us to test and estimate the multiplicative effects of the experimental treatment on the hand reaction time. We use the function `lancova`.
